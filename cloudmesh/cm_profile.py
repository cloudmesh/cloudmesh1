...
class cm_profile (object):
    ...
    def update(self, username, dict, cloud=None, page=None):
        """
        updates for the username the dict and if a page is given also includes
        the page
        """
    ...
    def write(self, username, dict, cloud=None, page=None, update=False):
        """
        updates for the username the dict and if a page is given also includes
        the page. if update is set to True, it jsut works as an update function,
