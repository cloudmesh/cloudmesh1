...
for bare metal provisioning so that cobler and OpenStack bare
...
FG Move (in production?, Hardware issues?):  
   ...
   service makes use of cobbler to dynamically provision the selected
...
Cloudmesh Service Shift:
      ...
      abstraction for bare metal provisioning so
      OpenStack bare metal provisioning can be used.
